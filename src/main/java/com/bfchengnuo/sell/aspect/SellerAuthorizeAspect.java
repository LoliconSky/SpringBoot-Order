package com.bfchengnuo.sell.aspect;
...
public class SellerAuthorizeAspect {
     ...
     * 切点表达式
     */
    @Pointcut("execution(public * com.bfchengnuo.sell.controller.Seller*.*(..))" +
            "&& !execution(public * com.bfchengnuo.sell.controller.SellerUserController.*(..))")
    public void verify() {
    }
